...
def generate_launch_description():
	...
	xacro_file = get_package_share_directory('mybot_description')+ "/urdf/kr210_gazebo.urdf.xacro"
	...
	# Gazebo   
	world_file_name = 'sim_world.world'
	world = os.path.join(get_package_share_directory('mybot_description'), 'worlds', world_file_name)
